...
| ------------- | ----------- | -------------- |
| Java Servlets | JSP         | MySQL/JDBC     |
| MVC Pattern   | HTML/CSS/JS | Tomcat 9       |
| Session Mgmt  | Bootstrap?  | Maven          |
| DAO Pattern   | jQuery?     | JDBC           |

## 🚀 Quick Start

**Prerequisites**: Java 8+, Tomcat 9+, MySQL (optional)

```bash
git clone https://github.com/amanjakunnel/E-Voting.git
cd "E-Voting System using Java"

# Deploy to Tomcat
# 1. Import as Maven project (IntelliJ/Eclipse)
# 2. Or copy WAR to webapps/
# 3. Start Tomcat: http://localhost:8080/E-Voting
